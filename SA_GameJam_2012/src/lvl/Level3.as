package lvl
{
	...
	{
		[Embed(source = '../../assets/leveldata/level3/mapCSV_Level3_Level.csv', mimeType = 'application/octet-stream')] public var map1CSV:Class;
		[Embed(source = '../../assets/leveldata/level3/mapCSV_Level3_OrbShards.csv', mimeType = 'application/octet-stream')] public var map1orbshardsCSV:Class;
		[Embed(source = '../../assets/leveldata/level3//mapCSV_Level3_Oyos.csv', mimeType = 'application/octet-stream')] public var map1oyosCSV:Class;
		[Embed(source = '../../assets/leveldata/level3//mapCSV_Level3_airOyos.csv', mimeType = 'application/octet-stream')] public var map1airOyosCSV:Class;
		[Embed(source = '../../assets/leveldata/level3/mapCSV_Level3_Oraclus.csv', mimeType = 'application/octet-stream')] public var map1oraclusCSV:Class;
