package lvl
{
	...
	{
		[Embed(source = '../../assets/leveldata/Level6/mapCSV_Level6_Level.csv', mimeType = 'application/octet-stream')] public var map1CSV:Class;
		[Embed(source = '../../assets/leveldata/Level6/mapCSV_Level6_OrbShards.csv', mimeType = 'application/octet-stream')] public var map1orbshardsCSV:Class;
		[Embed(source = '../../assets/leveldata/Level6//mapCSV_Level6_Oyos.csv', mimeType = 'application/octet-stream')] public var map1oyosCSV:Class;
		[Embed(source = '../../assets/leveldata/Level6//mapCSV_Level6_airOyos.csv', mimeType = 'application/octet-stream')] public var map1airOyosCSV:Class;
		[Embed(source = '../../assets/leveldata/Level6/mapCSV_Level6_Oraclus.csv', mimeType = 'application/octet-stream')] public var map1oraclusCSV:Class;
