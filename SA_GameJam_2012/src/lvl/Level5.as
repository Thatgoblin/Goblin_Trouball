package lvl
{
	...
	{
		[Embed(source = '../../assets/leveldata/Level5/mapCSV_Level5_Level.csv', mimeType = 'application/octet-stream')] public var map1CSV:Class;
		[Embed(source = '../../assets/leveldata/Level5/mapCSV_Level5_OrbShards.csv', mimeType = 'application/octet-stream')] public var map1orbshardsCSV:Class;
		[Embed(source = '../../assets/leveldata/Level5//mapCSV_Level5_Oyos.csv', mimeType = 'application/octet-stream')] public var map1oyosCSV:Class;
		[Embed(source = '../../assets/leveldata/Level5//mapCSV_Level5_airOyos.csv', mimeType = 'application/octet-stream')] public var map1airOyosCSV:Class;
		[Embed(source = '../../assets/leveldata/Level5/mapCSV_Level5_Oraclus.csv', mimeType = 'application/octet-stream')] public var map1oraclusCSV:Class;
