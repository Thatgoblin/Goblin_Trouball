package lvl
{
	...
	{
		[Embed(source = '../../assets/leveldata/Level8/mapCSV_Level8_Level.csv', mimeType = 'application/octet-stream')] public var map1CSV:Class;
		[Embed(source = '../../assets/leveldata/Level8/mapCSV_Level8_OrbShards.csv', mimeType = 'application/octet-stream')] public var map1orbshardsCSV:Class;
		[Embed(source = '../../assets/leveldata/Level8//mapCSV_Level8_Oyos.csv', mimeType = 'application/octet-stream')] public var map1oyosCSV:Class;
		[Embed(source = '../../assets/leveldata/Level8//mapCSV_Level8_airOyos.csv', mimeType = 'application/octet-stream')] public var map1airOyosCSV:Class;
		[Embed(source = '../../assets/leveldata/Level8/mapCSV_Level8_Oraclus.csv', mimeType = 'application/octet-stream')] public var map1oraclusCSV:Class;
